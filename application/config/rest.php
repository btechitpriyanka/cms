...
|
*/
$config['jwt_secret_key'] = 'o2n0oritwb4cc4gc48kwsco';
$config['jwt_token_expire'] = 86500;
//$config['jwt_token_expire'] = 120;
...
$config['auth_override_class_method_http']['jwt']['token']['post'] = 'jwt';
...
|
*/
$config['rest_keys_table'] = 'api_details';
